...
)
{
    ...
    group->elements[child_idx++] = test_dstring_new();
    group->elements[child_idx++] = test_dstring_new_with_capacity();
    group->elements[child_idx++] = test_dstring_new_from_cstr();
    group->elements[child_idx++] = test_dstring_new_from_cstr_n();
    group->elements[child_idx++] = test_dstring_new_from_buffer();
    group->elements[child_idx++] = test_dstring_new_copy();
    group->elements[child_idx++] = test_dstring_new_fill();
    group->elements[child_idx++] = test_dstring_new_formatted();
    group->elements[child_idx++] = test_dstring_free();
    group->elements[child_idx++] = test_dstring_free_contents();
