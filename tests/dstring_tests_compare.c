...
/******************************************************************************
* test_dstring_equals_ignore_case
******************************************************************************/
...
/******************************************************************************
* test_dstring_equals_cstr_ignore_case
******************************************************************************/
...
)
{
    ...
    group->elements[child_idx++] = test_dstring_cmp();
    group->elements[child_idx++] = test_dstring_cmp_cstr();
    group->elements[child_idx++] = test_dstring_ncmp();
    group->elements[child_idx++] = test_dstring_ncmp_cstr();
    group->elements[child_idx++] = test_dstring_casecmp();
    group->elements[child_idx++] = test_dstring_casecmp_cstr();
    group->elements[child_idx++] = test_dstring_ncasecmp();
    group->elements[child_idx++] = test_dstring_ncasecmp_cstr();
    group->elements[child_idx++] = test_dstring_equals();
    group->elements[child_idx++] = test_dstring_equals_cstr();
    group->elements[child_idx++] = test_dstring_equals_ignore_case();
    group->elements[child_idx++] = test_dstring_equals_cstr_ignore_case();
