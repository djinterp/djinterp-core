...
)
{
    ...
    group->elements[child_idx++] = test_dstring_reserve();
    group->elements[child_idx++] = test_dstring_shrink_to_fit();
    group->elements[child_idx++] = test_dstring_capacity();
    group->elements[child_idx++] = test_dstring_resize();
